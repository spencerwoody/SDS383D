...
We have a model where $$(y_i | \theta, \sigma^2), \; i = 1, \ldots n,$$ $$(\theta | \sigma) \sim \pN (\mu, \tau^2 \sigma^2),$$ $$\sigma^2 \sim \text{IG}(\frac{d}{2}, \frac{\eta}{2}).$$ Define $\omega = \frac{1}{\sigma^2}$ and $\kappa = \frac{1}{\tau^2}$, so now $$(\theta|\omega) \sim \pN(\mu, (\omega\kappa)^{-1}),$$ and $$\omega \sim \text{Gamma}(\frac{d}{2}, \frac{\eta}{2}).$$
